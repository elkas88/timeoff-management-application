...
module.exports = function(sequelize, DataTypes) {
  ...
  Department.prototype.promise_team_view_for_months_range = function(start_month, end_month) {
        ...
        users_and_leaves.forEach(user_data => {
          ...
          for (let i = 0; i <= number_of_months; i++) {
            let calendar_month = new CalendarMonth(
              ...
              {
                bank_holidays : self.include_public_holidays ? company.bank_holidays : [],
