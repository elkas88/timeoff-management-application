...
module.exports = function(sequelize, DataTypes){
  ...
  Schedule.promise_to_build_default_for = function(args) {
  ...
  Schedule.prototype.is_user_specific = function() {
    return !!this.user_id;
  };

  Schedule.prototype.is_it_working_day = function(args) {
    var day = args.day;
  ...
  Schedule.prototype.works_monday = function() {
    return this.monday === works_whole_day();
  };

  Schedule.prototype.works_tuesday = function() {
    return this.tuesday === works_whole_day();
  };

  Schedule.prototype.works_wednesday = function() {
    return this.wednesday === works_whole_day();
  };

  Schedule.prototype.works_thursday = function() {
    return this.thursday === works_whole_day();
  };

  Schedule.prototype.works_friday = function() {
    return this.friday === works_whole_day();
  };

  Schedule.prototype.works_saturday = function() {
    return this.saturday === works_whole_day();
  };

  Schedule.prototype.works_sunday = function() {
